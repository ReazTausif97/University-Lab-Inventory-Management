...
{
    public partial class FCLab1A : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = con.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "select * from FCLab1 where ProductName= '" + textBox1.Text + "'";
            cmd.ExecuteNonQuery();
            DataTable dt = new DataTable();
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            da.Fill(dt);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (textBox3.Text != "")
            {
                cmd.CommandText = "update FCLab1 set ExistingQuantity= '" + textBox2.Text + "',InStock='" + textBox3.Text + "' where ProductName='" + textBox1.Text + "'";
                cmd.ExecuteNonQuery();
                con.Close();
                disp_data();
                clear();
            ...
            else if (a < B)
            {
                ...
                cmd.CommandText = "update FCLab1 set ExistingQuantity= '" + c + "',InStock='" + b + "' where ProductName='" + textBox1.Text + "'";
                cmd.ExecuteNonQuery();
                con.Close();
                disp_data();
                clear();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = con.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "delete from FCLab1 where ProductName='" + textBox1.Text + "'";
            cmd.ExecuteNonQuery();
            con.Close();
            disp_data();
            clear();
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = con.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "insert into FCLab1 values('" + textBox1.Text + "','" + textBox2.Text + "','" + textBox3.Text + "')";
            cmd.ExecuteNonQuery();
            con.Close();
            disp_data();
            clear();
        ...
        private void FCLab1A_Load(object sender, EventArgs e)
        {
            con.Open();
            string str = "FCLab1A";
